...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo site_url('pembelian/tambah') ?>" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="" class="col-xl-2 col-md-6">Tanggal</label>
                <input name="tanggal" id="tanggal" type="date" class="form-control col-xl-3 col-md-6 <?php echo form_error('tanggal') ? 'is-invalid' : '' ?>" value="<?= set_value('tanggal'); ?>">
            ...
            <div class="form-group row">
                ...
                <input type="text" name="supplier" id="supplier" class="form-control col-xl-3 col-md-5 <?php echo form_error('supplier') ? 'is-invalid' : '' ?>" value="<?= set_value('supplier') ?>">
                <div class="invalid-feedback col-xl-3 offset-xl-1 col-md-6">
            ...
            <div class="form-group row">
                ...
                <input name="kodeBarang" id="kodeBarang" type="text" class="form-control col-xl-3 col-md-6 <?php echo form_error('kodeBarang') ? 'is-invalid' : '' ?>" value="<?= set_value('kodeBarang') ?>" placeholder="ex: D94V" readonly>
                <div class="invalid-feedback col-xl-3 offset-xl-1 col-md-6">
            ...
            <div class="form-group row">
                ...
                <input name="namaBarang" id="namaBarang" type="text" class="form-control col-xl-3 col-md-6 <?php echo form_error('namaBarang') ? 'is-invalid' : '' ?>" value="<?= set_value('namaBarang') ?>" placeholder="-" readonly>
                <div class="invalid-feedback col-xl-3 offset-xl-1 col-md-6">
            ...
            <div class="form-group row">
                ...
                <input name="stokGudang" id="stokGudang" type="number" class="form-control col-xl-3 col-md-6 <?php echo form_error('stokGudang') ? 'is-invalid' : '' ?>" value="<?= set_value('stokGudang') ?>" placeholder="-" readonly>
                <div class="invalid-feedback col-xl-3 offset-xl-1 col-md-6">
            ...
            <div class="form-group row">
                ...
                <input type="number" class="form-control col-xl-2 col-md-5 <?php echo form_error('stokIn') ? 'is-invalid' : '' ?>" value="<?= set_value('stokIn') ?>" id="stokIn" name="stokIn" placeholder="ex: 50">
                <div class="invalid-feedback col-xl-3 offset-xl-1 col-md-6">
